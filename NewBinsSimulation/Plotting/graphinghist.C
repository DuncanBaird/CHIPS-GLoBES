...
void graphinghist(){
  ...
  ifstream file;
  file.open("/home/duncan/Documents/CHIPS Repository/CHIPS-GLoBES/NewBinsSimulation/Plotting/histsim.dat");
...
file.close();
  ...
  myCanvas->Update();
  myCanvas->SaveAs("/home/duncan/Documents/CHIPS Repository/CHIPS-GLoBES/NewBinsSimulation/Plotting/CHIPShist-First.pdf");
