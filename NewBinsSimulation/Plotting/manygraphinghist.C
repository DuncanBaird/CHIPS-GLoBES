...
void manygraphinghist(){
  ...
  sprintf(buf,"/home/duncan/Documents/CHIPS Repository/CHIPS-GLoBES/NewBinsSimulation/Plotting/time1histsim_channel%d.dat",k);
  strcpy(str,buf);
...
file.close();
  ...
  myCanvas->Update();
  myCanvas->SaveAs("/home/duncan/Documents/CHIPS Repository/CHIPS-GLoBES/NewBinsSimulation/Plotting/CHIPShist-manytime.pdf");
