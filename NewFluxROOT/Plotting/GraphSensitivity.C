...
double x2[31];// array that can hold 100 numbers for 1st column 
  ...
  infile2.open("/home/duncan/Documents/CHIPS Repository/CHIPS-GLoBES/NewFluxROOT/Plotting/Input/allaCorrDouble.dat");// file containing numbers in 3 columns 
...
for(int u=0;u<31;++u){
  ...
  myCanvas->SaveAs("/home/duncan/Documents/CHIPS Repository/CHIPS-GLoBES/NewFluxROOT/Plotting/Output/SensitivityplotAChiCompared3.svg");
