...
nuflux(\#\+Reactor)$<$  = \char`\"{}\+Reactor.\+dat\char`\"{}  = 5 /$\ast$ years $\ast$/  = 8.\+4 /$\ast$ G\+Wth $\ast$/  = 3.\+317709228e-\/12 /$\ast$ Near detector is less efficient than far detector $\ast$/ \begin{quote}
...
\$profiletype = 3 \$densitytab = \{ 1e-\/6 \} \$lengthtab = \{ 0.\+1 \} /$\ast$ km $\ast$/
