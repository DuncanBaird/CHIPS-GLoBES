...
//////////////////////////Begin Output File////////////////////////////////////
  ...
  TString outputfilename = "./forSim.root";//"./chi2Calc_output.root";
  ...
  //Duncan Matrices
  TH2D *h_cov_cc_rel = new TH2D(*CoVarCC_relative);
  TH2D *h_cov_nc_rel = new TH2D(*CoVarNC_relative);
  TH2D *h_cov_cc_inv = new TH2D(*CoVarCC_inverted);
  TH2D *h_cov_nc_inv = new TH2D(*CoVarNC_inverted);

  h_cov_cc_rel->Write("d_cov_cc_rel");
  h_cov_nc_rel->Write("d_cov_nc_rel");
  h_cov_cc_inv->Write("d_cov_cc_inv");
  h_cov_nc_inv->Write("d_cov_nc_inv");
