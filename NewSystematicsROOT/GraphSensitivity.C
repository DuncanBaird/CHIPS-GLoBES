...
int GraphSensitivity(){
  ...
  infile.open("/home/duncan/Documents/CHIPS Repository/CHIPS-GLoBES/NewSystematics/insima.dat");// file containing numbers in 3 columns 
...
for(int u=0;u<31;++u){
  ...
  myCanvas->SaveAs("/home/duncan/Documents/CHIPS Repository/CHIPS-GLoBES/NewSystematics/Plotting/SensitivityplotA.pdf");
