...
int GraphSensitivity(){
  ...
  infile.open("/home/duncan/Documents/CHIPS Repository/CHIPS-GLoBES/NewSystematicsROOT/Plotting/Input/allaCorr2.dat");// file containing numbers in 3 columns 
...
for(int u=0;u<31;++u){
  ...
  myCanvas->SaveAs("/home/duncan/Documents/CHIPS Repository/CHIPS-GLoBES/NewSystematicsROOT/Plotting/Output/SensitivityplotAChiCompared3.svg");
